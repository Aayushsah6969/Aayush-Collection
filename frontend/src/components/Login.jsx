...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.post('https://aayush-collection-backend.onrender.com/user/login', formData);
  ...
  return (
    <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 dark:bg-gray-800">
      <div className="w-full max-w-md bg-white p-8 rounded-lg shadow-lg dark:bg-gray-600">
        ...
        <p className="text-center text-gray-500 mt-2 dark:text-white">Forgot Password? <a className='text-green-600' href="">Reset Now</a></p>
